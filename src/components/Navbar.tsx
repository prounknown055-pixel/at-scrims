          ...
          >
            <div className="relative">
              ...
              <img
                ...
                alt="AT Logo"
                className="w-16 h-16 object-contain relative z-10 logo-glow"
                onError={(e) => {
            ...
            <div className="hidden sm:block">
              <span className="text-xl font-black text-white tracking-tighter uppercase italic block">
                Admin&apos;s Tournament
              </span>
              <span className="text-[8px] text-cyan-500/60 font-black uppercase tracking-[0.4em] block mt-1">
                Esports Arena
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            {user && !user.isAdmin && (
              <button
                ...
                className={`at-btn flex flex-col items-center px-6 py-2 rounded-2xl transition-all border ${
                  currentView === 'wallet'
            ...
            <div className="flex items-center gap-3 bg-slate-900/50 p-1.5 rounded-2xl border border-slate-800">
              ...
              <button
                ...
                className={`at-btn w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                  isMusicPlaying
              ...
              <div className="flex items-center gap-4 border-l border-slate-900 pl-4">
                {user.isAdmin && (
                  <button
                    ...
                    className={`at-btn w-12 h-12 rounded-2xl flex items-center justify-center border transition-all ${
                      currentView === 'admin'
                ...
                <button
                  onClick={onLogout}
                  className="at-btn w-12 h-12 bg-slate-900 text-slate-600 rounded-2xl flex items-center justify-center hover:text-red-400 border border-slate-800"
                >
